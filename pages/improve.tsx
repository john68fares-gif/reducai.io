...
export default function Improve() {
  ...
  useEffect(() => {
    ...
    // Reset the “once” counters when switching away from a media tab to a different media tab or text
    return () => {
      // no-op cleanup; counters reset when switching *to* a different tab type:
    };
