...
export default function AccountPage() {
  ...
  // plan + usage (client-side placeholder; hook to your backend when ready)
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // read plan + usage if you store it in metadata
      const p = (user?.user_metadata as any)?.plan_tier as PlanTier | undefined;
      if (p && ['Free', 'Pro', 'Team', 'Enterprise'].includes(p)) setPlan(p);
      ...
      unsub = supabase.auth.onAuthStateChange((_e, session) => {
        ...
        if (pt && ['Free', 'Pro', 'Team', 'Enterprise'].includes(pt)) setPlan(pt);
      });
    })();
          ...
          <div className="grid grid-cols-1 gap-7">
            ...
            <Card title="Pricing">
              <div className="space-y-4">
                ...
                <PlanRow
                  title="Free"
                  subtitle="Demo only — limited usage"
                  price="€0"
                  period="/ forever"
                  ...
                  ctaLabel={plan === 'Free' ? 'Current plan' : 'Demo only'}
                  ctaDisabled
                />
                ...
                <PlanRow
                  ...
                  ctaHref="mailto:sales@reducai.io"
                />

                {/* Enterprise (placeholder) */}
                <PlanRow
                  title="Enterprise"
                  subtitle="Scale with SLAs"
                  price="Custom"
                  period=""
