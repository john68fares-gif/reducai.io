...
import { KeyRound, Plus, ChevronDown, Trash2, CheckCircle2, Zap, X, Key as KeyIcon } from 'lucide-react';
...
function ApiKeysScreen() {
  ...
  // Load keys and previously selected id (client only)
  useEffect(() => {
    const l = loadKeys();
    setList(l);
    const saved = isBrowser ? localStorage.getItem(LS_SELECTED) : null;
  ...
  function removeKey(id: string) {
    ...
    setToast(`API Key for “${removedName}” removed successfully`);
  }
