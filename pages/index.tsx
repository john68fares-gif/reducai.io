    ...
    <main style={STYLES.page}>
      ...
      <section style={STYLES.heroWrap}>
        ...
        >
          ...
          <p style={STYLES.sub}>
            Pixel-perfect, fast, and simple. Create an agent, refine the prompt, test replies, then deploy.
          </p>
          ...
          <div style={STYLES.trustRow}>
            ...
            <div style={STYLES.sep} /><div style={STYLES.dot} /><span>No backend to start</span>
          </div>
        </motion.div>
        ...
        <div style={STYLES.cards}>
          ...
          <FeatureCard title="Support AI" body="Answer FAQs, deflect tickets, on-brand tone." accent="#7cc3ff" />
          <FeatureCard title="Start Blank" body="Bring your own prompt; full control." accent="#b28bff" />
        </div>
      </section>
