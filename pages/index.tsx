...
import {
  Wand2, Mic, Shield, CheckCircle2, ArrowRight, CreditCard
} from 'lucide-react';
...
// Your real Stripe price IDs (LIVE or TEST — must match your STRIPE_SECRET_KEY mode)
const PRICE_IDS = {
  starter: {
...
export default function Home() {
  ...
  async function beginCheckout(priceId: string) {
    try {
      ...
      // no @stripe/stripe-js: just let Stripe redirect the browser
  ...
  return (
    <>
      ...
      {/* TOKENS — exactly the same flavor as your overlays/account */}
      <style jsx global>{`
        .va-scope{
        ...
        <header className="w-full" style={{ borderBottom:`1px solid ${GREEN_LINE}` }}>
          <nav className="mx-auto max-w-[1160px] px-5 lg:px-6 h-[66px] flex items-center justify-between">
            ...
            <div className="flex items-center gap-8">
              <a className="btn btn-secondary" href="/auth?mode=signin" style={{ borderRadius:999 }}>Sign in</a>
              <button
        ...
        <section className="section">
          <div className="mx-auto max-w-[1160px] px-5 lg:px-6 grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-[36px] md:text-[42px] leading-[1.1] font-semibold">
                Build & launch AI voice agents — in minutes.
              </h1>
              <p className="mt-3 text-[15px]" style={{ color:'var(--text-muted)' }}>
                Rounded controls, clean overlays, no noise. Connect your data, choose a voice, go live.
              </p>
            ...
            <div className="va-card p-6">
              ...
              <div className="mt-4 text-xs" style={{ color:'var(--text-muted)' }}>
                Configurable after checkout.
              </div>
            </div>
          </div>
        </section>

        {/* FEATURES (overlay-style cards) */}
