...
const Tokens = () => (
  <style jsx global>{`
    ...
    .va-card{ border-radius:10px; border:1px solid var(--border-weak); background:var(--panel-bg);
      box-shadow:var(--card-shadow); overflow:hidden; isolation:isolate; }

    .va-head{
      min-height:var(--header-h); display:grid; grid-template-columns:1fr auto; align-items:center;
        ...
        <div className="px-3 md:px-5 lg:px-6 py-5 mx-auto w-full max-w-[1160px]" style={{ fontSize:'var(--fz-body)', lineHeight:'var(--lh-body)' }}>
                ...
                <div style={{ position:'relative' }}>
                  {!inInlineReview ? (
                    <textarea
                      ...
                      style={{ minHeight: 360, background:'var(--panel)', border:'1px solid rgba(255,255,255,.10)', color:'var(--text)' }}
          ...
          >
            ...
            <div className="mt-4 grid sm:grid-cols-2 gap-3">
              <div className="flex items-center justify-between p-3 rounded-[10px]" style={{ background:'var(--panel)', border:'1px solid rgba(255,255,255,.10)' }}>
