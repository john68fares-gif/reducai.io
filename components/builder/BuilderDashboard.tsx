...
{[bot.name, bot.industry, bot.language].filter(Boolean).join(' · ') || '—'} </div> </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <button onClick={onClose} className="p-2 rounded-full hover:bg白/10" aria-label="Close" title="Close">
...
>
<Plus className="w-10 h-10" style={{ color: '#6af7d1', opacity: 0.9 }} /> </div> <div className="text-[20px]">Create a Build</div> <div className="text-[13px] text白/65 mt-2">Start building your AI assistant</div> </button>
);
}
